...
//                 <Link key={index} to={`/project-detail/${project._id}`}>
//                   <div className="rounded-[50px] shadow-lg overflow-hidden flex w-full bg-[#102762] xs:flex-col lg:flex-row">
...
//                         <h3 className="text-3xl lg:text-4xl font-bold mb-2 text-black">{project.name}</h3>
...
//                         <span className="text-black text-lg lg:text-xl font-bold mt-2">Worked on</span>
...
//                       <div className="text-black text-lg lg:text-xl font-bold mt-6">Technology Used</div>
...
;
  ...
  return (
    <>
      <section className="bg-white">
        <div className="py-8 px-4   lg:py-16 lg:px-10">
          <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h2 className="mb-4 lg:text-5xl font-extrabold text-gray-900 text-4xl">
              My Projects
            </h2>
                    ...
                    <div className="p-5 w-full border">
                      ...
                      <div className="flex space-x-4 text-black justify-around">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="hover:text-black flex justify-center items-center cursor-pointer  px-4 py-2 rounded-full text-2xl lg:text-xl gap-2 "
                        >
                          <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path
                              fillRule="evenodd"
                        ...
                        <a
                          href={project.live_link}
                          className="hover:text-gray-900 flex justify-center items-center  px-4 py-2 rounded-full text-2xl lg:text-xl  gap-2 "
                        >
                          <svg className="w-10 h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path
                              fillRule="evenodd"
                        ...
                        <Link key={index} to={`/project-detail/${project.id}`} className='text-end  flex justify-center items-center text-2xl lg:text-xl'>        <span >Read More...</span>            </Link>
                      </div>
